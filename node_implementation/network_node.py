...
from final_values import MAIN_SERVER_ADDRESS, NODE_COMMUNICATION_PORT, SERVER_SOCKET_TIMEOUT
...
import socket
from node_implementation.node_storage import NodeStorage
from general_system_functions import get_node_approval, request_additional_storage_space, initial_server_connect
import threading
from util_functions import selection_sort, get_key_for_lowest_value
...
class NetworkNode:
    ...
    def _handle_data_allocation(self, packet):
        ...
        packet = Packet(PacketTypes.DATA_RECEIVED_CONFIRM, sender_type=NetworkMemberTypes.STORAGE_NODE, token=self.node_id)
